...
完整的 protobuf 定义见 `protos/cpl.proto`（包：`cpl.v1`，Go 包：`github.com/unixcli/unicli-os/pkg/cpl/v1`）。
...
```json
{
  ...
  "image": {
    "ref": "ghcr.io/unixcli/image.resize:1.0.0",
...
import (
    ...
    cplpb "github.com/unixcli/unicli-os/pkg/cpl/v1"
)
