...
[![CI](https://github.com/unixcli/unicli-os/actions/workflows/ci.yml/badge.svg)](https://github.com/unixcli/unicli-os/actions/workflows/ci.yml)
[![Platform](https://img.shields.io/badge/Platform-Linux%20%7C%20macOS%20%7C%20Windows-lightgrey)](https://github.com/unixcli/unicli-os)
...
```bash
curl -fsSL https://raw.githubusercontent.com/unixcli/unicli-os/main/install.sh | sh
```

Or download a pre-built binary from [Releases](https://github.com/unixcli/unicli-os/releases).

**Windows (PowerShell):**

```powershell
powershell -c "irm https://raw.githubusercontent.com/unixcli/unicli-os/main/install.ps1 | iex"
```
...
```json
{
  ...
  "image": {
    "ref": "ghcr.io/unixcli/hello.say:1.0.0",
