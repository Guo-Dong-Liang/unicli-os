...
$REPO_URL = $env:UNICLI_REPO ? $env:UNICLI_REPO : "https://github.com/Guo-Dong-Liang/unicli-os"
$RELEASE_VERSION = $env:UNICLI_VERSION ? $env:UNICLI_VERSION : "v0.1.0"
...
try {
    ...
    Write-Host "  ⚠ Release 下载失败，尝试从源码构建..."
